create database Etech collate Modern_Spanish_CI_AS
go
...
create table t_viajeros
(
    id         int identity
        constraint PK_t_viajeros
            primary key,
...
create table r_viajero_viaje
(
    id         int identity
        constraint PK_r_viajero_viaje
            primary key,
    viajero    int      not null
        constraint FK_r_viajero_viaje_t_viajeros
            references t_viajeros,
    viaje      int      not null
        constraint FK_r_viajero_viaje_t_viajes
            references t_viajes,
    creado     datetime not null,
    modificado datetime,
    eliminado  datetime
